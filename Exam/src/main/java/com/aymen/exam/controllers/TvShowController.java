...
public class TvShowController {
	...
	@GetMapping("/shows/{id}")
	public String showOne(@PathVariable("id") Long showID,Model model) {
	...
	public String updateForm(@ModelAttribute("show")TvShow show,@PathVariable("showID")Long showID,Model model){
